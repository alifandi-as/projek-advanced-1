        ...
        <div class="login-box">
            <div class="login-container">
                <form action="process/register" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" min="1" required name="telephone" class="input-box"><br>
                    <label>Password:</label><br>
                    <input type="password" required name="password" class="input-box"><br>
                    <label>Konfirmasi Password:</label><br>
                    <input type="password" required name="password_confirm" class="input-box"><br>
                    <label>Sekolah</label><br>
                    <select name="school_id" class="input-box" id="school_id">
